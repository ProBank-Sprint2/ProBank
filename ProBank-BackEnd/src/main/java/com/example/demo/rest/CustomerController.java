 ...
 * 
 * 
 * main purpose of this class is to use C.R.U.D. functionality of Rest Full JPA
 * it provides get, put, post & delete mapping
 * URL created in the front end part ie. in angular services also utilizes this controller
 * this functionality mentioned above is done after the SPring Started Boot Project's server starts hosting
 * 
 * 
 */
...
//  public Address addaddress(@PathVariable Long customerId, @Valid @RequestBody Address address) 
//  {
...
//  public Account addAccount(@PathVariable Long customerId, @Valid @RequestBody Account Account) 
//  {
//      return customerRepository.findById(customerId).map(customer -> 
//              {
...
//  public Account updateAccount(@PathVariable Long accountId, @Valid @RequestBody Account AccountUpdated)
//  {
